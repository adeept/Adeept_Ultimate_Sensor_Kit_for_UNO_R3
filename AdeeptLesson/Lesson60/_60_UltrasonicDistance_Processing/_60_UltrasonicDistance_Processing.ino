/***********************************************************
File name: _60_UltrasonicDistance_Processing.ino
...
int value = 0;//ultrasonic measurement data storage
...
{ 
   ...
   Serial.write(cm);           // Print a centigrade temperature to the serial montiol
   delay(100);
}
